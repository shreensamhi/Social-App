...
async function createPost(){
  ...
  return (
    <>
      <div className="bg-white dark:bg-gray-900 dark:text-gray-100 rounded-md shadow-2xl 
                shadow-cyan-100 dark:shadow-gray-800 mt-4 p-5 relative transition-colors duration-300">
  ...
  <div className="mt-3">
    <div className="flex gap-2">
      <img alt="" className="block w-10 h-10 rounded-full mt-2" src={user} />
    ...
    <div className="mt-4 relative w-full flex justify-center">
      ...
      <button
        ...
        className="absolute top-2 right-2 bg-black/60 text-white px-2 py-1 rounded hover:bg-black/80 text-xs"
      >
        ✕
      </button>
    </div>
